...
<br>
<form action="{{route('candidato.incluir')}}" method="POST">  @csrf
<div class="col-md-6 offset-md-3">
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="cidade" class="form-control" id="email" name="email" placeholder="">
    </div>
  </div>
  </br>
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="atuacao" class="form-control" id="linkeding" name="linkeding" placeholder="">
    </div>
  </div>
  </br>
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="num_func" class="form-control" id="github" name="github" placeholder="">
    </div>
  </div>
</br>
