...
<div class="   col-md-6 offset-md-3">
  <div class="form-group row">
    ...
    <label for="inputEmail3" class="col-sm-2 col-form-label">Descrição Vaga:</label>
    <div class="col-sm-10">
      <input type="cidade" class="form-control" id="descricao" placeholder="">
    </div>
  </div>
  </br>
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="atuacao" class="form-control" id="salario" placeholder="">
    </div>
  </div>
</br>
